...
@_typing.overload
def type(x: _builtins.list[_T], /) -> _typing.Literal["list"]: ...
@_typing.overload
def type(x: _builtins.dict[_T, _U], /) -> _typing.Literal["dict"]: ...
@_typing.overload
def type(x: _builtins.tuple[_T, ...], /) -> _typing.Literal["tuple"]: ...
@_typing.overload
def type(x: _builtins.set[_T], /) -> _typing.Literal["set"]: ...
@_typing.overload
